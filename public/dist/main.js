	...
	exports['default'] = {
	  ...
	  methods: {
	    ...
	    onSelectCard: function onSelectCard(id) {
	      ...
	      this.$root.cache.detail = _commonUtil2['default'].getItemById(this.items, id);
	...
	exports['default'] = {
	  ...
	  methods: {
	    ...
	    onClickItem: function onClickItem(id) {
	      // store to cache
	      this.$root.cache.request.detail = _commonUtil2['default'].getItemById(this.items, id);
